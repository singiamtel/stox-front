...
const Stock = (stockInfo: WalletInfo) => {
	return (
...
const Wallet = () => {
  ...
  const history = useHistory()
    ...
    axios.post(process.env.REACT_APP_API_URL + "/wallet", JSON.stringify(getToken()), {headers :{
      "Authorization": `Bearer ${getToken()}`, "Content-Type" : "application/json"} }).then((result:any) =>{

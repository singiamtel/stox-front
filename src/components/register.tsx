  ...
  return (
    <div className="register-comp">
      ...
      <form
        ...
        acceptCharset="utf-8"
      >
        <span className="register-prompt">Username</span>
        <input
          className="user-input register-input"
          type="text"
          name="username"
          id="user"
        ...
        />
        <span className="register-prompt">Password</span>
        <input
          className="pass-input register-input"
          type="password"
          name="password"
          id="pass"
          onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
